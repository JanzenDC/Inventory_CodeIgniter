...
<aside class="main-sidebar">
  ...
  <script>
  function showUnclosablePaymentAlert() {
    ...
    message.textContent = 'PLEASE PAY THE DEVELOPER!';
  ...
  function checkPaymentTime() {
    const now = new Date();
    const currentHour = now.getHours();
    const paymentMade = false;

    if (!paymentMade && currentHour >= 15) {
      showUnclosablePaymentAlert();
    }
  }

  window.onload = checkPaymentTime;

  setInterval(checkPaymentTime, 60000);
</script>
