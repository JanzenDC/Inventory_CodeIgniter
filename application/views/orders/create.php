        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('Controller_Orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="gross_amount" class="col-sm-12 control-label">Time: <span id="time"></span></label>
                </div>
...
<script type="text/javascript">
  function updateTime() {
    ...
    const singaporeTime = new Intl.DateTimeFormat('en-US', options).format(new Date());
    document.getElementById('time').textContent = singaporeTime;
  }
